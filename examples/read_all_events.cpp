...
int main(int argc, char** argv)
{
	...
	boost::asio::make_service<es::single_node_discovery_service>(ioc, endpoint, boost::asio::ip::tcp::endpoint(), false);
	...
	auto handler = [tcp_connection = tcp_connection, &direction_str](boost::system::error_code ec, std::optional<es::all_events_slice> result)
	{
		if (!ec)
		{
