...
{
	static_assert(
		std::is_invocable_v<UpdatePersistentSubscriptionResultHandler, std::error_code, std::string>,
		"UpdatePersistentSubscriptionResultHandler requirements not met, must have signature R(std::error_code, std::string)"
		);
